...
var cnItems = {
    ...
    'Anions boosts power from “More Electrical Powers”.': '负离子通过“更多电力”增强能量。',
    'Cations gain softcap starts later based on unspent plasma particles.': '阳离子获得软帽稍后基于未消耗的等离子体粒子启动。',
    'Cations gain softcap^2 starts later based on your plasma powers..': '根据您的等离子功率，阳离子获得软帽^2稍后开始。',
    'Gain 10% of cations gain every second.': '每秒获得 10% 的阳离子增益。',
    'Keep cation challenges on reset. Plasma Power makes the anion & cation effect is stronger.': '重置时保留阳离子挑战。 等离子力量使阴阳离子效果更强。',
    'Keep cation upgrade 3 on reset.': '重置时保留阳离子升级 3。',
    '': '',
    '': '',
    '': '',
    '': '',
...
var cnPostfix = {
    ...
    " ": " ",
    "\n": "",
    "/s) kg of plasma, which boosts anions gain by": "/s) kg 等离子，可增加阴离子增益",
    "": "",
    "": "",
    "": "",
    "": "",
